...
static int tree_add_node(Tree *t)
{
    ...
    { // se a qnt de nos atual e maior que a capacidade, dobra a capacidade
                     ...
                     uint32_t *rng, int *scratch)
{
    ...
    {
        if (counts[k] == n)
        { // se todos os elementos da classe k estao em uma posicao so do histograma, o node é puro
            pure = 1;
            break;
        }
    }
